...
![図1: ソフトウェア開発ライフサイクル（共通フレーム2013に基づく）](figs/sdlc_workflow.png)
...
![図2: spec-kit ワークフロー全体像](figs/spec_kit_workflow.png)
...
![図7: 人件費削減額 vs AI 投資額の対比](figs/cost_benefit.png)

**図7: 人件費削減額 vs AI 投資額の対比（標準シナリオ）**
...
![図8: ばらつき抑制の仕組み](figs/variability_suppression.png)
...
![図9: 仕様駆動開発による価値創出の全体像](figs/value_creation.png)

**図9: 仕様駆動開発による価値創出の全体像**
